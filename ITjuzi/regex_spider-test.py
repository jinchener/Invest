...
if __name__ == "__main__":
	...
	startUrlList = ["http://sh.lianjia.com/xiaoqu/putongxinqu"]
	#["http://pinyin.sogou.com/dict/"]
	downUrlRegex = r"(http://sh.lianjia.com/xiaoqu/([a-z]{2,20}))|(http://sh.lianjia.com/xiaoqu/([a-z]{2,20})/d[0-9]{1,2})" 
	...
	writeUrlRegex =r"(http://sh.lianjia.com/xiaoqu/([a-z]{2,20})/d[0-9]{1,2})"  
