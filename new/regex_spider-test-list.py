...
class regexSpider:
    ...
    def spiderWorking(self, startUrlList, downUrlRegex, writeUrlRegex,ignoreUrlRegex, writeFileName ,deepMax):
        ...
        file_object_Z = open(writeFileName, "a")
        try:
...
if __name__ == "__main__":
    ...
    '''
    startUrlList = ["http://sh.lianjia.com/xiaoqu/chuansha/"]
    #["http://pinyin.sogou.com/dict/"]
    downUrlRegex = r"(http://sh.lianjia.com/xiaoqu/chuansha/d[0-9]{1,2})"
    ...
    writeUrlRegex =r"(http://sh.lianjia.com/xiaoqu/chuansha/d[0-9]{1,2})"
