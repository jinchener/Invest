...
class regexSpider:
	...
	def get_pagenum(page):
		...
		numlist = pageilst.get('page-data')
		num = eval(numlist)['totalPage']
...
if __name__ == "__main__":
	...
	startUrlList = ["http://tj.lianjia.com/xiaoqu/putongxinqu"]
	#["http://pinyin.sogou.com/dict/"]
	downUrlRegex = r"(http://tj.lianjia.com/xiaoqu/([a-z]{2,20}))|(http://tj.lianjia.com/xiaoqu/([a-z]{2,20})/pg[0-9]{1,2})" 
	...
	writeUrlRegex =r"(http://tj.lianjia.com/xiaoqu/([a-z]{2,20})/pg[0-9]{1,2})"  
		#"(http://pinyin\.sogou\.com/dict/cell\.php\?id=.*)|(http://download\.pinyin\.sogou\.com/dict/download_cell\.php.*)"
	ignoreUrlRegex = "(.*author\.php.*)|(.*search\.php.*)|(.*goto\.php.*)|(.*#top)|(.*rs.*)|(.*j[0-9]{1,10}.*)|(.*y[0-9]{1,10}.*)|(.*w[0-9]{1,10}.*)|(.*t[0-9]{1,10}.*)|(.*s[0-9]{1,10}.*)|(.*p[0-9]{1,10}.*)"
